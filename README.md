...
[![Release](https://img.shields.io/badge/release-v0.39.0-blue)](https://github.com/Jayson-Furr/VeritySpec/releases/tag/v0.39.0)
...
Latest release: `v0.39.0`. Release history is tracked in
...
- Generators for OpenAPI, AsyncAPI, TypeScript types, Python models, schema
  ...
  deployment reports, cross-pack coverage dashboards, product-impact reports,
  pack capability indexes, and roadmap governance reports, with OpenAPI
...
- Product-surface pack boundary guidance for future GUI, desktop, mobile, and
  ...
  `verity.pack.gameplay`, `verity.pack.content`, and `verity.pack.economy`.
...
```bash
pip install "verityspec @ git+https://github.com/Jayson-Furr/VeritySpec.git@v0.39.0"
verity --version
```
...
VeritySpec package `v0.39.0` supports workspace formats `v0.1.0` and

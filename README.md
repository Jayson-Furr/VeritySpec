...
[![Release](https://img.shields.io/badge/release-v0.76.0-blue)](https://github.com/Jason-Furr/verity-spec/releases/tag/v0.76.0)
...
Latest release: `v0.76.0`. Release history is tracked in
...
VeritySpec package `v0.76.0` supports workspace formats `v0.1.0` and

...
[![Release](https://img.shields.io/badge/release-v0.42.0-blue)](https://github.com/Jayson-Furr/VeritySpec/releases/tag/v0.42.0)
...
Latest release: `v0.42.0`. Release history is tracked in
...
```bash
pip install "verityspec @ git+https://github.com/Jayson-Furr/VeritySpec.git@v0.42.0"
verity --version
```
...
VeritySpec package `v0.42.0` supports workspace formats `v0.1.0` and

...
Latest release: `v0.12.0`. Release history is tracked in
...
```bash
pip install "verityspec @ git+https://github.com/Jayson-Furr/VeritySpec.git@v0.12.0"
verity --version
```
...
VeritySpec package `v0.12.0` supports workspace formats `v0.1.0` and

...
[![Release](https://img.shields.io/badge/release-v0.19.0-blue)](https://github.com/Jayson-Furr/VeritySpec/releases/tag/v0.19.0)
...
VeritySpec package `v0.19.0` supports workspace formats `v0.1.0` and

...
[![Release](https://img.shields.io/badge/release-v0.36.0-blue)](https://github.com/Jayson-Furr/VeritySpec/releases/tag/v0.36.0)
...
Latest release: `v0.36.0`. Release history is tracked in
...
VeritySpec package `v0.36.0` supports workspace formats `v0.1.0` and

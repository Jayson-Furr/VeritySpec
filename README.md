...
[![Release](https://img.shields.io/badge/release-v0.65.0-blue)](https://github.com/Jason-Furr/verity-spec/releases/tag/v0.65.0)
...
Latest release: `v0.65.0`. Release history is tracked in
...
VeritySpec package `v0.65.0` supports workspace formats `v0.1.0` and

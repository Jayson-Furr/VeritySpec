  ...
  verity:
    ...
    steps:
      ...
      - name: Install VeritySpec
        run: pip install "verityspec @ git+https://github.com/Jayson-Furr/VeritySpec.git@v0.23.0"
...
jobs:
  verity:
    uses: Jayson-Furr/VeritySpec/.github/workflows/product-contract.yml@v0.23.0
    with:
      workspace: .
```

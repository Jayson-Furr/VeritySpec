  ...
  verity:
    ...
    steps:
      ...
      - name: Install VeritySpec
        run: pip install "verityspec @ git+https://github.com/Jason-Furr/verity-spec.git@v0.53.0"
...
jobs:
  verity:
    uses: Jason-Furr/verity-spec/.github/workflows/product-contract.yml@v0.53.0
    with:
      workspace: .
```
